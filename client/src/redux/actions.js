...
export function getCountries() {
  ...
  return async function (dispatch) {
    try {
      const response = await axios("http://pi-countries-api-nine.vercel.app/api/v1/countries");
      return dispatch({
  ...
  return async function (dispatch) {
    try {
      const { data } = await axios.get(
        `http://pi-countries-api-nine.vercel.app/api/v1/countries/?name=${name}`
      );
  ...
  return async function (dispatch) {
    try {
      const response = await axios.get(
        `http://pi-countries-api-nine.vercel.app/api/v1/countries/:${id}`
      );
      return dispatch({
        type: GET_BY_DETAIL,
...
export function getActivity() {
  return async function (dispatch) {
    try {
      const response = await axios.get("http://pi-countries-api-nine.vercel.app/api/v1/activities");
      return dispatch({
        type: GET_ACTIVITY,
        payload: response.data,
      });
...
export function postActivity(payload) {
  return async function () {
    try {
      const res = await axios.post("http://pi-countries-api-nine.vercel.app/api/v1/activities", payload);
      return res;
    } catch (error) {
      console.log(error);
    }
